                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel widget">
                                <div class="panel-heading widget-title">
                                    <h3 class="panel-title">Edit Banner Page</h3>
                                    <div class="right">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <?php echo $this->Form->create($banners,["class"=>"form-auth-small","type" => "file","onsubmit"=>"return validateForm()"]); ?>
                                            <div class="col-md-6">
                                                ...
                                                <?php if($banners->id != 4 && $banners->id != 5 && $banners->id != 6) { ?>
                                                <div class="form-group">
                                                ...
                                                <?php } ?>
                                                <input type="hidden" name="oldImg" value="<?php echo $banners->bannerImage;  ?>">
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
