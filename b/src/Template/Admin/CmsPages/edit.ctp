                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel widget">
                                <div class="panel-heading widget-title">
                                    <h3 class="panel-title">Edit Cms Page</h3>
                                    <div class="right">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <?php echo $this->Form->create($cmspages,["class"=>"form-auth-small","type" => "file","onsubmit"=>"return validateForm()"]); ?>
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label class="fancy-checkbox">
                                                        <input type="checkbox" class="form-control" name="isActive" <?php echo $cmspages->isActive==1 ? "checked" : ""; ?>>
                                                        <span>Active</span>
                                                    </label>
                                                </div>
                                            </div>
