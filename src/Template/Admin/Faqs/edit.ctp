                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel widget">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <?php echo $this->Form->create($faq,["class"=>"form-auth-small","onsubmit"=>"return validateForm()"]); ?>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="page-name" class="control-label">Question</label>
                                                    <?php echo $this->Form->input('question',['type'=>'text','class' => 'form-control pName','label'=>false,'id' => 'page-name','placeholder'=>'Question']); ?>
                                                ...
                                                <div class="form-group">
                                                    <label class="fancy-checkbox">
                                                        <input type="checkbox" class="form-control" name="isActive" <?php echo $faq->isActive==1 ? "checked" : ""; ?>>
                                                        <span>Active</span>
                                                    </label>
                                                </div>
