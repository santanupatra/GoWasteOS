						...
						<div class="col-md-12">
							...
							<div class="panel widget">
								<div class="panel-heading widget-title">
									<h3 class="panel-title">Service Provider To Customer</h3>
									<div class="right">
...
<script type="text/javascript">
	...
	function ratingfilter(value){
		if(value){
			window.location.href='<?php echo $this->Url->build(["controller"=>"Reviews", "action"=>"service_provider"]); ?>?rating='+value;
		}
	}
</script>