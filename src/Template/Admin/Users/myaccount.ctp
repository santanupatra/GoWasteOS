                                        ...
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php echo $this->Form->input('phoneNumber',['class' => 'form-control phone','label'=>false,'id' => 'mobile-number','placeholder'=>'Mobile']); ?>
                                                    <p class="phoneError error-message"></p>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label for="image-upload" class="control-label">Image</label>
                                                    <?php echo $this->Form->input('userImage',['type' => 'file','label'=>false,'id'=>'image-upload']); ?>
                                                </div>
                                                <input type="hidden" name="oldimg" value="<?php echo $user['userImage']; ?>">
                                                <div class="form-group">
                                                    <?php if ($user['userImage'] != '') { ?>
                                                    <img src="<?php echo $this->Url->build('/'.$user->userImage); ?>" id="user-image" alt="User Image" class="show-image">
                                                    <?php } else { ?>
