						...
						<div class="col-md-12">
							...
							<div class="panel widget">
								...
								<div class="panel-body">
									<!-- <a href="<?php echo $this->Url->build(["controller"=>"Homepages", "action"=>"add"]); ?>" class="btn btn-info pull-right add-tag-top"><i class="fa fa-plus"></i> Add New Banner</a> -->
									<table class="table table-hover table-bordered pt-2" id="competitionTable">
										...
										<tbody>
											...
											<tr>
											<td><?php if($bnr['bannerImage'] != ''){ ?><img src="<?php echo $this->Url->build('/'.$bnr['bannerImage']); ?>" class="status-image" /><?php } ?></td>
												<td><?php echo $bnr['bannerTitle']; ?></td>
												<td>
													<a href="<?php echo $this->Url->build('/admin/homepages/edit/'.base64_encode($bnr['id'])); ?>" class="btn btn-info btn-xs gap-btn"><i class="fa fa-edit edit-tag-icon"></i> Edit</a>
													<a href="<?php echo $this->Url->build('/'); ?>" class="btn btn-success btn-xs gap-btn" target="_blank"><i class="fa fa-eye edit-tag-icon"></i> View</a>
