						...
						<div class="col-md-12">
							...
							<div class="panel widget">
								...
								<div class="panel-body">
									<div class="row">
                                        <?php echo $this->Form->create($price,["class"=>"form-auth-small","type" => "file","onsubmit"=>"return validateForm()"]); ?>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="city_id" class="form-control" id="city_id" onchange="getService()">
                                                        ...
                                                        <option value="<?php echo $city['id']; ?>" <?php if($price['city_id']==$city['id']){ echo "selected";} ?>><?php echo $city['name']; ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="service_id" class="form-control" id="service_id">
                                                        ...
                                                        <option value="<?php echo $service['id']; ?>" <?php if($price['service_id']==$service['id']){ echo "selected";} ?>  ><?php echo $service['title']; ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                    </div>
