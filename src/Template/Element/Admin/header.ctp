<!--NAVBAR -->
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="brand">
                <a href="<?php echo $this->Url->build('/admin/users/dashboard'); ?>"><img src="<?php echo $this->Url->build('/'.$setting['logo']); ?>" alt="Logo" class="img-responsive logo"></a>
            </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span><?php echo $admin_details['name']; ?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
