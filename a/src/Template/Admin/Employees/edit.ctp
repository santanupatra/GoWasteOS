                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel widget">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <?php echo $this->Form->create($employee,["class"=>"form-auth-small","type" => "file","onsubmit"=>"return validateForm()"]); ?>
                                            <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="page-name" class="control-label">Employee Image</label>
                                                    <?php echo $this->Form->input('userImage',['class' => 'form-control', 'type' => 'file', 'label'=>false]); ?>
                                                    <p class="pNameError error-message"></p>
                                                </div>
                                                <input type="hidden" name="oldImg" value="<?php echo $employee->userImage;  ?>">
                                                <div class="form-group">
