...
--
-- Host: localhost:3306
-- Generation Time: Oct 13, 2020 at 03:16 PM
...
CREATE TABLE `banners` (
  ...
  `bannerContent` mediumtext DEFAULT NULL,
...
(1, 'Cadly', 'info@cadly.ca', 'siteLogo/5f70cc24013b7.png', 'siteLogo/5f70cc24012c2.png', '123456', '123456', 'KOlkata', 'https://www.facebook.com/cadlycreations', 'https://twitter.com/cadlycreations', 'https://www.instagram.com/cadlycreations', 'https://www.youtube.com/');
...
INSERT INTO `users` (`id`, `firstName`, `lastName`, `email`, `password`, `phoneNumber`, `profilePicture`, `isAdmin`, `isActive`, `isDeleted`, `createdDate`) VALUES
(1, 'Admin', 'admin', 'admin@admin.com', '$2y$10$FxG3Sb59.WZBATu7R5ERFeYwKX1cQNGqHsYPk/0thjQAVl6YuNcc6', NULL, NULL, 1, 1, 0, '2020-09-27 22:57:08'),
(2, 'Subha', 'Ghosh', 'wat.subhamoy@gmail.com', '$2y$10$GeMVxA4QANb.tHxAnisxceAblj42kjvgEwXC9SqhwQ.3dIPn7e7jy', '9851103612', NULL, 0, 1, 0, '2020-10-03 04:26:53');
